...
public class SparkSqlJava001 {
    ...
    public static void main(String[] args) {
        ...
        //Dataset stuDataset = sparkSession.read().schema("id INT, name STRING, age INT").json("/Users/allen/bigdataapp/sparkdemo001/src/resources/input/students.json");
        Dataset stuDataset = sparkSession.read().json("/Users/allen/bigdataapp/sparkdemo001/src/resources/input/students.json");
