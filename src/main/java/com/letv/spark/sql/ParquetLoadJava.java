...
public class ParquetLoadJava {
    ...
    public static void main(String[] args) {
        ...
        // 加载 com/letv/spark/sql/SaveAndLoadFileJava.java 输出的 parquet 数据
       /* Dataset<Row> ds = sparkSession
                .read()
                .parquet("/Users/allen/bigdataapp/sparkdemo001/src/resources/output1/part-00000-72f31f97-d09c-4720-9b1d-8e5103d69a2e-c000.snappy.parquet");
*/

       // 读取分区文件
        Dataset<Row> ds = sparkSession
                .read()
                .option("basePath", "/Users/allen/bigdataapp/sparkdemo001/src/resources/output1/")
                .parquet("/Users/allen/bigdataapp/sparkdemo001/src/resources/output1/gender=male");
